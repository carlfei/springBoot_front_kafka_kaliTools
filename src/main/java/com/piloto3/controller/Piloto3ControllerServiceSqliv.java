...
import com.piloto3.model.MensajeriaSqliv;

import com.piloto3.service.Piloto3ServiceGeneral;
import com.piloto3.service.Piloto3ServiceSqliv;

@RestController
public class Piloto3ControllerServiceSqliv {

	String test = "";
	JSONObject jsonObject;

	@Autowired
	Piloto3ServiceSqliv piloto3ServiceSqliv;

	@Autowired
	MensajeriaSqliv mensajeriaSqliv;
	...
	ArrayList<MensajeriaSqliv> allusers = new ArrayList<MensajeriaSqliv>();

	@RequestMapping(value = "Sqliv_service", method = RequestMethod.POST)
	public void doPostSqlivrouter(HttpServletRequest req, HttpServletResponse res) throws java.io.IOException {
		...
		if (test.length() == 10) { // el identificador desde la segunda llamada
			...
			if (this.metodoOperador(test, ping) == "no" || piloto3ServiceGeneral.testUrl(dataNet.getIp()) == "no") {
				...
				allusers.add(new MensajeriaSqliv());
				...
				service.submit(new Runnable() {
					public void run() {
						...
						piloto3ServiceSqliv.engine(command, allusers.get(allusers.size() - 1), allusers);
	...
	public String metodoOperador(String test, String term) {///////////////////////////////////////////////////////////////////
		...
		mensajeriaSqliv.setOperator(mensajeriaSqliv); // manda el objeto para que opere desde el
...
//////////////////////////////////////////////////////////////////////////////////////////
	...
	public void metodoEnd(String id, ArrayList<MensajeriaSqliv> users) { // finaliza el servicio
		...
		if (id != "-") {
			piloto3ServiceSqliv.saleDbucle("1", id, users); // manda vaciar y eliminar el objeto
		}
