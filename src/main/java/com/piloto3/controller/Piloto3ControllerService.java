...
import com.piloto3.model.Mensajeria;

import com.piloto3.service.Piloto3Service;
import com.piloto3.service.Piloto3ServiceGeneral;

@RestController
public class Piloto3ControllerService {

	String test = "";
	JSONObject jsonObject;

	@Autowired
	Piloto3Service piloto3Service;
	...
	ArrayList<Mensajeria> allusers = new ArrayList<Mensajeria>();

	@RequestMapping(value = "nmap_service", method = RequestMethod.POST)
	public void doPostNmaprouter(HttpServletRequest req, HttpServletResponse res) throws java.io.IOException {
		...
		if (test.length() == 10) { // el identificador desde la segunda llamada
			...
			//	String command = "sudo docker run -t uzyexe/nmap "+ dataNet.getCommand()+" "+ dataNet.getIp();
				String command = "sudo docker run -t uzyexe/nmap "+ dataNet.getIp();
				...
				service.submit(new Runnable() {
					public void run() {
						...
						piloto3Service.engine(command, allusers.get(allusers.size() - 1), allusers);
	...
	public String metodoOperador(String test, String term) {///////////////////////////////////////////////////////////////////
		...
		mensajeria.setOperator(mensajeria); // manda el objeto para que opere desde el
...
//////////////////////////////////////////////////////////////////////////////////////////
	...
	public void metodoEnd(String id, ArrayList<Mensajeria> users) { // finaliza el servicio
		...
		if (id != "-") {
			piloto3Service.saleDbucle("1", id, users); // manda vaciar y eliminar el objeto
		}
