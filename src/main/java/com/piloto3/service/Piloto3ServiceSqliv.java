...
@EnableAsync
@Service("Piloto3ServiceSqliv")
public class Piloto3ServiceSqliv {

	@Async
	public String engine(String command, MensajeriaSqliv obj, ArrayList<MensajeriaSqliv> users) {// el procedimiento
		try {
	...
	@Async
	public void saleDbucle(String datos, String id, ArrayList<MensajeriaSqliv> users) { // los datos que van saliendo
