...
@EnableAsync
@Service("Piloto3ServiceWhois")
public class Piloto3ServiceWhois {

	@Async
	public String engine(String command, MensajeriaWhois obj, ArrayList<MensajeriaWhois> users) {// el procedimiento
		try {
	...
	@Async
	public void saleDbucle(String datos, String id, ArrayList<MensajeriaWhois> users) { // los datos que van saliendo
