...
@EnableAsync
@Service("Piloto3ServiceTraceroute")
public class Piloto3ServiceTraceroute {

	@Async
	public String engine(String command, MensajeriaTraceroute obj, ArrayList<MensajeriaTraceroute> users) {// el
																											// procedimiento
		try {
	...
	@Async
	public void saleDbucle(String datos, String id, ArrayList<MensajeriaTraceroute> users) { // los datos que van
																								// saliendo
