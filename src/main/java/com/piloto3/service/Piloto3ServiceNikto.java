...
@EnableAsync
@Service("Piloto3ServiceNikto")
public class Piloto3ServiceNikto {

	@Async
	public String engine(String command, MensajeriaNikto obj, ArrayList<MensajeriaNikto> users) {// el procedimiento
																									// cmd
	...
	@Async
	public void saleDbucle(String datos, String id, ArrayList<MensajeriaNikto> users) { // los datos que van saliendo
