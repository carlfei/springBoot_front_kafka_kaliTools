...
@EnableAsync
@Service("Piloto3ServiceWhatweb")
public class Piloto3ServiceWhatweb {

	@Async
	public String engine(String command, MensajeriaWhatweb obj, ArrayList<MensajeriaWhatweb> users) {// el procedimiento
		try {
...
System.out.println(" EEEEEEEEEEE:::::: "+e.getMessage());
	...
	@Async
	public void saleDbucle(String datos, String id, ArrayList<MensajeriaWhatweb> users) { // los datos que van saliendo
