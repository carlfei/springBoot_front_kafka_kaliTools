...
@EnableAsync
@Service("Piloto3ServiceWpscan")
public class Piloto3ServiceWpscan {

	@Async
	public String engine(String command, MensajeriaWpscan obj, ArrayList<MensajeriaWpscan> users) {// el procedimiento
		try {
	...
	@Async
	public void saleDbucle(String datos, String id, ArrayList<MensajeriaWpscan> users) { // los datos que van saliendo
