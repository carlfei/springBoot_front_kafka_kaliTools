...
@EnableAsync
@Service("Piloto3ServiceUrlcrazy")
public class Piloto3ServiceUrlcrazy {

	@Async
	public String engine(String command, MensajeriaUrlcrazy obj, ArrayList<MensajeriaUrlcrazy> users) {// el procedimiento
		try {
...
System.out.println(" EEEEEEEEEEE:::::: "+e.getMessage());
	...
	@Async
	public void saleDbucle(String datos, String id, ArrayList<MensajeriaUrlcrazy> users) { // los datos que van saliendo
																							// del procedimiento cmd
